...
export const addFreelancerAddress = async (req, res, next) => {
  try {
    const { currentAddress, id } = req.body;
    ...
    return res.status(200).json({ message: 'Freelancer address updated successfully' });
  } catch (error) {
